...
def create_md5_error_report():
    ...
    report += "<h3>Note: This program is looking for MD5.txt files in the novogene format.</h3>\n"
    report += "<h4>Note: novogene format is md5_hash' 2 spaces 'filename'</h4>\n"
    report += "</body>\n</html>"
